...
#ifndef __HGEKEYCODE_H__
#define __HGEKEYCODE_H__

#define HGE_KEYTOKEN_UUID				hgeid
...
#define HGE_KEYTEXT_SERVICE_MEMOIZER					"><"
#define HGE_KEYTEXT_SERVICE_MEMOIZER_STREAM_DEFAULT		""
