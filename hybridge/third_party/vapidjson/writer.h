#ifndef VAPIDJSON_WRITER_H_
#define VAPIDJSON_WRITER_H_
...
public:
	...
	Writer& EndObject(SizeType memberCount = 0) {
		VAPIDJSON_ASSERT(level_stack_.GetSize() >= sizeof(Level));
		VAPIDJSON_ASSERT(!level_stack_.template Top<Level>()->inArray);
