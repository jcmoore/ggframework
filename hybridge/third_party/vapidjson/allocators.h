#ifndef VAPIDJSON_ALLOCATORS_H_
#define VAPIDJSON_ALLOCATORS_H_
...
public:
	...
	*/
	...
	{
		VAPIDJSON_ASSERT(buffer != 0);
		VAPIDJSON_ASSERT(size > sizeof(ChunkHeader));
	...
	*/
	...
	void* Realloc(void* originalPtr, size_t originalSize, size_t newSize) {
		...
		if (originalPtr == (char *)(chunkHead_ + 1) + chunkHead_->size - originalSize) {
			...
			increment = VAPIDJSON_ALIGN(increment);
		...
		VAPIDJSON_ASSERT(newBuffer != 0);	// Do not handle out-of-memory explicitly.
